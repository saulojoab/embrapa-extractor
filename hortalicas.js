export const data = [
  {
    id: 0,
    popularNames: ["Abóbora"],
    scientificName: "Cucurbita moschata Duch.",
    description:
    ...
    bestWayToPlant:
      "É favorecida por temperaturas elevadas. Tolera temperaturas  amenas (entre 15° e 25°C), mas não resiste a geadas. Dias curtos, com menor exposição do Sol,  favorecem a floração feminina, resultando em maior produtividade. Em regiões de inverno suave,  é possível plantar o ano todo, desde que haja irrigação.",
    bestTimeToPlant: {
      south: "OUT/FEV",
      southeast: "SET/MAR",
      northeast: "MAR/OUT",
  ...
  },
  {
    ...
    bestWayToPlant:
      "Desenvolve-se melhor sob temperaturas amenas (entre 15° e  25°C). Temperaturas elevadas podem prejudicar a polinização. Não tolera geadas.",
    bestTimeToPlant: {
      south: "SET/MAIO",
      southeast: "AGO/MAIO",
      northeast: "MAR/OUT",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento A abobrinha pode ser consumida refogada no óleo ou  azeite, cozida, em saladas frias, como suflê, frita à milanesa, recheada ou como ingrediente em  bolos, pizza e pastelões. Seu cozimento é rápido e não é necessário acrescentar água, pois a água  da abobrinha é suficiente para cozinhá-la. É comercializada em caixas plásticas e vendida ao  consumidor final a granel ou em bandejas, com os frutos inteiros ou já cortados.2",
  },
  {
    id: 2,
    popularNames: ["Acelga"],
    ...
    bestWayToPlant:
      "Desenvolve-se melhor sob temperaturas amenas (entre 15° e  25°C), sendo plantadas geralmente nos períodos de outono e inverno em regiões de baixa altitude.  Em regiões mais altas, com verão suave, pode-se plantar durante todo o ano.",
    bestTimeToPlant: {
      south: "FEV/JUL",
      southeast: "FEV/JUL",
      northeast: "NAO_RECOMENDADO",
      midwest: "NAO_RECOMENDADO",
      north: "ABR/JUN",
    },
    bestWaysToUse:
      "Recomendações de aproveitamento Pode ser consumida crua, em saladas, e refogada como  a couve. É vendida em maços, e os caules podem ser consumidos fritos ou cozidos em sopas. 3 CARLOS ADONAE NERI SOLANO",
  },
  {
    id: 3,
    popularNames: ["Agrião"],
    scientificName: "Nasturtium officinale sp.",
    description:
    ...
    bestWayToPlant:
      "Desenvolve-se melhor sob temperaturas amenas (entre 15° e  25°C), sendo plantado geralmente nos períodos de outono e inverno. Onde o verão não é muito  quente, pode ser plantado o ano inteiro.",
    bestTimeToPlant: {
      south: "FEV/OUT",
      southeast: "FEV/JUL",
      northeast: "MAR/SET",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento Pode ser usado cru, em saladas, molhos, pães, sopas e  cozidos. Também é utilizado com mel na medicina popular para curar tosse e bronquite. É vendido  em maços ou minimamente processado, já desinfetado, em embalagens com outras hortaliças. 4",
  },
  {
    id: 4,
    popularNames: ["Alcachofra"],
    ...
    bestWayToPlant:
      "A cultura exige frio para se desenvolver bem, mas é sensível a geada.",
    bestTimeToPlant: {
      south: "FEV/MAR",
      southeast: "FEV/MAR",
      northeast: "NAO_RECOMENDADO",
      midwest: "NAO_RECOMENDADO",
      north: "NAO_RECOMENDADO",
    },
    bestWaysToUse:
      "Recomendações de aproveitamento As flores são consumidas cozidas. Deve-se retirar a parte  fibrosa central de cada alcachofra, isto é, os “espinhos”. Pode acompanhar carnes ou compor  molhos e tortas. 5",
  },
  {
    id: 5,
    popularNames: ["Alface"],
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento Todas as folhas podem ser aproveitadas. As alfaces roxa e  verde são consumidas predominantemente em saladas frescas. A alface americana é mais crocante  e, além de seu uso em saladas, é indicada para o preparo de sanduíches por ser mais resistente ao  calor. Podem ser limpas e embaladas em agroindústria, sendo vendidas já prontas para consumo. 6",
  },
  {
    id: 6,
    popularNames: ["Alho"],
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento Pode ser usado na fabricação de molhos, pastas e temperos  prontos pela agroindústria. O alho também tem sido vendido na forma de chips e frito, pronto para  o consumo. É utilizado para temperar grande parte dos alimentos preparados em casa: sopas,  arroz, feijão, carnes, molhos e massas. 7",
  },
  {
    id: 7,
    popularNames: ["Alho-porro"],
    scientificName: "Allium ampeloprasum L.",
    description:
    ...
    bestWayToPlant:
      "É planta típica de frio e deve ser plantada nos períodos de  outono  e inverno.",
    bestTimeToPlant: {
      south: "MAR/JUN",
      southeast: "MAR/JUN",
      northeast: "MAIO/JUN",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento No Brasil, ainda é pouco usado na culinária, porém seu  uso tem aumentado nas agroindústrias para produção de sopas desidratadas. Pode ser usado em  saladas, para temperar carnes e pratos finos, além de sopas. Deve ser manuseado com cuidado  para evitar escurecimento do talo.8",
  },
  {
    id: 8,
    popularNames: ["Almeirão ou chicória amarga"],
    ...
    bestWayToPlant:
      "Produz melhor sob temperaturas amenas (entre 15° e 25°C),  sendo plantado geralmente nas estações de outono e inverno.",
    bestTimeToPlant: {
      south: "FEV/OUT",
      southeast: "FEV/AGO",
      northeast: "FEV/AGO",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento Pode ser consumido cru em saladas ou refogado como a  couve, podendo substituí-la. Também pode ser usado no preparo de tortas, bolinhos e sopas ou  como acompanhamento do arroz e feijão. É vendido em maços de folhas.9",
  },
  {
    id: 9,
    popularNames: ["- batata"],
    scientificName: "Solanum tuberosum ssp. tuberosum",
    description:
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento A batata é uma hortaliça consumida em todo o mundo, das  mais diversas formas. Acompanha carnes, peixes e aves, podendo ser cozida, assada ou frita. É  utilizada na forma de purês, em massas (nhoque), salgados, tortas e sopas. Ultimamente tem-se  observado crescimento na venda da batata já processada (cortada e embalada) juntamente com outras hortaliças, como chuchu e cenoura, para o preparo de sopas e maioneses.",
  },
  {
    id: 10,
    popularNames: ["Batata-doce"],
    scientificName: "Ipomoea batatas L.",
    description:
    ...
    bestWayToPlant:
      "A cultura da batata-doce se desenvolve bem em temperaturas mais  elevadas. O frio pode reduzir a produtividade e aumentar o ciclo da cultura. Não tolera geadas. Em  regiões de baixa altitude, com inverno suave, é possível plantar durante todo o ano.",
    bestTimeToPlant: {
      south: "OUT/DEZ",
      southeast: "OUT/DEZ",
      northeast: "ANO_TODO",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento A batata-doce pode se consumida cozida, assada ou frita,  acompanhando diversos pratos. Até os brotos e folhas podem ser consumidos, refogados ou em  sopas. Na indústria, a batata-doce é matéria-prima para fabricação de álcool, farinha (amido),  pães e doces. As raízes e ramas também podem ser usadas na alimentação animal. 11",
  },
  {
    id: 11,
    popularNames: ["Berinjela"],
    scientificName: "- Solanum melongena L.",
    description:
      "É uma planta arbustiva, resistente e vigorosa. Produzem frutos roxo-escuros ou quase  negros. É rica em vitamina A, B1, B2, B5, C, potássio, fósforo, cloro, cálcio, sódio, ferro, magnésio  e enxofre. O plantio é realizado via semente, em bandejas com posterior transplantio para o campo.",
    bestWayToPlant:
      "É uma planta de clima quente, sendo favorecida pelo calor,  principalmente para a germinação, emergência e formação da muda.",
    bestTimeToPlant: {
      south: "AGO/JAN",
      southeast: "AGO/MAR",
      northeast: "ANO_TODO",
  ...
  },
  {
    ...
    popularNames: [
      ...
      "Couve-de-cerca",
      "João-gomes",
      "Espinafre-indiano (ásia)",
      "Folha- tartaruga (áfrica)",
    ],
    scientificName: "Basella alba e Basella rubra",
    description:
    ...
    bestWayToPlant:
      "Desenvolve-se melhor em regiões ensolaradas e com temperaturas  mais elevadas. Chuvas abundantes e bem distribuídas favorecem a cultura. Não tolera geadas.",
    bestTimeToPlant: {
      south: "SET/FEV",
      southeast: "SET/FEV",
      northeast: "SET/FEV",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento A bertalha pode substituir a couve ou o espinafre. Suas  folhas e ramos podem ser consumidos crus em saladas, ou cozidos em sopas, refogados e  recheios de tortas, panquecas e de outros pratos. Os ramos são comercializados em maços.13",
  },
  {
    id: 13,
    popularNames: ["Beterraba"],
    ...
    bestWayToPlant:
      "Desenvolve-se melhor sob temperaturas amenas (entre 15° e  25°C) ou baixas e resiste ao frio e geadas. Não tolera temperaturas e umidade muito elevadas.",
    bestTimeToPlant: {
      south: "ANO_TODO",
      southeast: "ANO_TODO",
      northeast: "ABR/AGO",
  ...
  },
  {
    ...
    bestWayToPlant:
      "Já existem cultivares adaptadas a clima mais quente. A escolha  da cultivar ideal, em relação ao clima da região e altitude, é fundamental. Para fazer a melhor  escolha, o produtor deve consultar o catálogo de cultivares da espécie.",
    bestTimeToPlant: {
      south: "FEV/SET",
      southeast: "FEV/JUL",
      northeast: "NAO_RECOMENDADO",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento O brócolis pode ser consumido cru, quando muito novinho,  ou cozido em saladas, sopas, suflês, refogado no arroz ou outros pratos. É uma hortaliça pouco  durável e deve ser consumida rapidamente após a colheita, exigindo uma boa coordenação entre  quem produz e distribui as hortaliças.15",
  },
  {
    id: 15,
    popularNames: ["- cebola"],
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento É usada principalmente para realçar o sabor dos alimentos.  Pode ser consumida em saladas, no preparo de sopas, carnes, patês, pizzas , biscoitos, frita à  milanesa ou assada. Também pode ser comercializada na forma de conservas e pastas.16",
  },
  {
    id: 16,
    popularNames: ["Cebolinha"],
    scientificName: "Allium schoenoprasum L.; Allium fistulosum L.",
    description:
    ...
    bestWayToPlant:
      "Produz melhor sob temperaturas amenas a frias (de 25ºC para  baixo), sendo plantadas geralmente nas estações de outono e inverno.",
    bestTimeToPlant: {
      south: "ANO_TODO",
      southeast: "ANO_TODO",
      northeast: "JUL",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento É utilizada para dar aroma e sabor a pratos variados, como sopas,  carnes, peixes e assados em geral. Pode ser congelada para aproveitamento posterior. Geralmente é  comercializada em maços juntamente com a salsa ou o coentro, o chamado cheiro-verde.17",
  },
  {
    id: 17,
    popularNames: ["Cenoura"],
    ...
    bestWayToPlant:
      "A faixa ideal para uma germinação rápida e uniforme das sementes  é de 20º a 30ºC. Para cultivares de verão, baixas temperaturas no campo induzem as plantas a  florescerem, o que só é desejável para produtores de sementes . Deve-se atentar à adequação da  cultivar com o clima na época de plantio.",
    bestTimeToPlant: {
      south: "FEV/AGO",
      southeast: "MAR/JUL",
      northeast: "NAO_RECOMENDADO",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento Além do consumo in natura em saladas (crua ou cozida) e  na forma de bolo, pão, purê, suflê, creme, doce ou suco, também é utilizada como matéria-prima  para indústrias processadoras de alimentos. Assim, são comercializadas na forma minimamente  processada (minicenouras, cubos, ralada, em rodelas) ou processada na forma de seleta de legumes, alimentos infantis e sopas instantâneas. 18",
  },
  {
    id: 18,
    popularNames: ["Chicória", "Escarola ou endívia"],
    scientificName: "Cichorium endivia L.",
    description:
      "Parecida com a alface, a chicória possui dois tipos de cultivares: a lisa (chamada escarola)  e a crespa (chamada endívia). É rica em fibras, vitaminas e minerais, em especial o potássio.",
    bestWayToPlant:
      "Produz melhor sob temperaturas não muito altas (amenas), entre  15º a 25ºC, sendo semeada normalmente nos períodos de outono e inverno. Em regiões altas de  clima ameno, pode ser plantada o ano todo.",
    bestTimeToPlant: {
      south: "FEV/JUL",
      southeast: "FEV/JUL",
      northeast: "FEV/AGO",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento Pode ser consumida crua em saladas e refogada, como a  couve. Substitui a couve em sopas, omeletes e até em sucos. Não deve ser cozida em excesso,  pois perde suas propriedades nutricionais devido ao calor.",
  },
  {
    id: 19,
    popularNames: ["Chuchu"],
    scientificName: "Sechium edule Sw.",
    description:
    ...
    bestWayToPlant:
      "Produz bem sob temperaturas amenas (entre 15° e 25°C), porém  não tolera frio excessivo. Calor e chuvas em excesso provocam queda das flores e ataque por  doenças causadas por fungos.",
    bestTimeToPlant: {
      south: "SET/OUT",
      southeast: "SET/OUT",
      northeast: "ANO_TODO",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento É consumido cozido em sopas e refogados, suflês, tortas e  em saladas frias. Atualmente tem-se observado o crescimento do comércio de chuchu cortado e  embalado para o preparo de sopas.20",
  },
  {
    id: 20,
    popularNames: ["Coentro"],
    scientificName: "C oriandrum sativum L.",
    description:
      "É uma hortaliça condimentar da mesma família da cenoura, da salsa e da mandioquinha- salsa. O coentro é rico em vitaminas A, B1, B2 e C. Normalmente é plantado em local definitivo,  via semente. As plantinhas devem ser desbastadas, ficando distanciadas de 8 a 10 centímetros uma da outra. É pouco exigente em relação ao solo e muito tolerante à acidez.",
    bestWayToPlant:
      "É uma cultura de clima quente e não tolera baixas temperaturas.",
    bestTimeToPlant: {
      south: "SET/JAN",
      southeast: "AGO/FEV",
      northeast: "ANO_TODO",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento Dá aroma e sabor a variados pratos. Pode ser ingrediente  de sopas, saladas, carnes e peixes e cozidos em geral. Deve ser colocado ao final do preparo,  para não ficar murcho. O coentro é geralmente comercializado em conjunto com a cebolinha,  composição chamada cheiro-verde. 21",
  },
  {
    id: 21,
    popularNames: ["Couve manteiga ou couve de folhas"],
    scientificName: "Brassica oleracea L. var. acephala D.C.",
    description:
      "Apresenta caule ereto e emite novas folhas continuamente ao redor do caule. É muito  rica em nutrientes, especialmente cálcio, ferro e vitaminas A, C, K e B5. Propaga-se por semente  ou por plantio do broto lateral. Essa é a forma de propagação mais comum. A cultura é bastante exigente em boro e molibdênio.",
    bestWayToPlant:
      "A couve é uma cultura típica dos períodos de outono e inverno,  apresentando certa tolerância ao calor. Pode ser plantada durante o ano todo, mas as épocas mais  indicadas por região estão descritas abaixo.",
    bestTimeToPlant: {
      south: "FEV/JUL",
      southeast: "FEV/JUL",
      northeast: "ABR/AGO",
  ...
  },
  {
    ...
    scientificName: "Brassica pekinensis (Lou.).",
    description:
    ...
    bestWayToPlant:
      "A maioria das cultivares tem melhor produção sob temperaturas  amenas (entre 15º e 25ºC), mas há cultivares mais tolerantes ao calor.",
    bestTimeToPlant: {
      south: "ANO_TODO",
      southeast: "ANO_TODO",
      northeast: "MAR/MAIO",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento As folhas podem ser consumidas cruas ou cozidas. É muito  usada na culinária oriental na preparação de macarrão e carnes. Pode ser usada em sopas, tortas,  misturadas no arroz e na salada (folhas cruas). 23",
  },
  {
    id: 23,
    popularNames: ["Couve-flor"],
    scientificName: "Brassica oleracea var. botritys",
    description:
      "É uma hortaliça rica em cálcio e fósforo e fonte de folato e vitamina C. A parte  comestível é a inflorescência (conjunto de floretes) ainda imatura, antes da abertura das flores.  As mudas devem ser produzidas em substrato enriquecido com cálcio e fósforo e pobre em nitrogênio. Assim como o brócolis, é muito exigente em adubação com boro e molibdênio. Deve- se irrigar bem a lavoura de couve-flor, mas sem excesso, para não favorecer o aparecimento de  doenças. Algumas folhas devem ser mantidas para a proteção da cabeça durante o transporte que, preferencialmente, deve ser feito sob refrigeração.",
    bestWayToPlant:
      "É fundamental a escolha da cultivar correta de acordo com a época  de plantio, pois há cultivares adaptadas a temperaturas mais quentes e a temperaturas mais  amenas, entre 15º e 25ºC.",
    bestTimeToPlant: {
      south: "FEV/JUN",
      southeast: "FEV/ABR",
      northeast: "FEV/JUL",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento É consumida cozida em saladas, tortas, sopas e molhos, além de  pratos fritos ou assados. Deve-se cozinhá-la antes de fritar ou assar. A couve-flor comercializada na forma minimamente processada vem apresentando crescimento considerável em diversos supermercados. A  cabeça é cortada em pequenos floretes, que são acomodados em bandejas envoltas por filmes plásticos.24",
  },
  {
    id: 24,
    popularNames: ["Ervilha"],
    ...
    bestWayToPlant:
      "Exige temperaturas amenas a frias (de 25ºC para baixo), adaptando- se às condições dos períodos de outono e inverno das regiões Sul, Sudeste e Centro-Oeste. Para não  prejudicar a qualidade dos grãos secos, não devem ocorrer chuvas no início da colheita.",
    bestTimeToPlant: {
      south: "ABR/MAIO",
      southeast: "ABR/MAIO",
      northeast: "NAO_RECOMENDADO",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento A ervilha é muito usada no preparo de pratos orientais (arroz  colorido) e no recheio de massas, panquecas e cachorro-quente. É muito apreciada em saladas  frias. Tanto as vagens comestíveis quanto os grãos (verdes e secos) são consumidos cozidos.25",
  },
  {
    id: 25,
    popularNames: ["Espinafre"],
    scientificName:
      "Spinacea oleracea L. (espinafre verdadeiro ou europeu) e Tetragonia expansa (Espinafre da Nova zelândia)",
    description:
    ...
    bestWayToPlant:
      "Pode ser cultivado numa ampla faixa de temperatura, mas produz  melhor sob temperaturas amenas (entre 15° e 25°C), com resistência ao calor. Não tolera frio  excessivo.",
    bestTimeToPlant: {
      south: "FEV/SET",
      southeast: "FEV/SET",
      northeast: "MAR/AGO",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento Pode ser consumido cru em saladas ou refogado, como a  couve, em sopas, cremes, molhos, tortas, omeletes e até em sucos. É comercializado em maços.",
  },
  {
    id: 26,
    popularNames: ["Feijão-vagem ou vagem"],
    ...
    bestWayToPlant:
      "Não tolera baixas temperaturas e geadas, desenvolvendo-se melhor  sob temperaturas amenas (entre 15° e 25°C) a altas. Em regiões com inverno ameno, é possível  o plantio durante o ano todo.",
    bestTimeToPlant: {
      south: "SET/MAR",
      southeast: "AGO/MAR",
      northeast: "ANO_TODO",
  ...
  },
  {
    ...
    bestWayToPlant:
      "Os rizomas se desenvolvem melhor em climas tropicais e subtropicais.  A planta é sensível à geada, e temperaturas abaixo de 13°C podem paralisar seu crescimento.",
    bestTimeToPlant: {
      south: "AGO/DEZ",
      southeast: "AGO/DEZ",
      northeast: "ANO_TODO",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento Com o gengibre, podem ser preparados condimentos,  refrigerantes, licores, cervejas e conservas. Com o óleo, preparam-se cosméticos. É utilizado como  condimento de pratos chineses e japoneses, picles e para o preparo do quentão (bebida alcoólica  com gengibre levada ao fogo).",
  },
  {
    id: 28,
    popularNames: ["Inhame (antigo cará)."],
    scientificName:
      "Dioscorea alata L. ; Dioscorea rotundata Poir; Dioscorea cayenensis",
    description:
    ...
    bestWayToPlant:
      "Desenvolve-se bem sob altas temperaturas e chuvas abundantes.  Não tolera frio nem geadas.",
    bestTimeToPlant: {
      south: "JUN/SET",
      southeast: "JUN/SET",
      northeast: "DEZ/JAN",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento O inhame é consumido geralmente cozido. Pode ser usado  das mesmas formas que a batata em sopas, caldos, purês e refogados. Também pode ser  ingrediente de pães, cremes, biscoitos, panquecas e tortas. Depois de cozido pode ser assado ou  frito. Pode ser vendido inteiro ou já processado (cortado e embalado).",
  },
  {
    id: 29,
    popularNames: ["Jiló"],
    scientificName: "Solanum gilo Raddi",
    description:
    ...
    bestWayToPlant:
      "É uma planta típica de clima tropical, sendo plantado nos períodos  de primavera e verão. Onde o inverno não é rigoroso, pode ser plantado o ano todo.",
    bestTimeToPlant: {
      south: "SET/FEV",
      southeast: "AGO/MAR",
      northeast: "MAR/SET",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento O jiló é consumido ainda verde e cozido, na forma de  refogados, saladas frias, farofas e recheios de tortas. Pode ser vendido em caixas ou embalado  em bandejas de isopor, o que aumenta seu valor de venda.",
  },
  {
    id: 30,
    popularNames: [
      ...
      "Mandioquinha",
      "Batata-salsa",
      "Batata  fiúza e cenoura-amarela",
    ],
    scientificName: "Arracacia xanthorrhiza Banc.",
    description:
    ...
    bestWayToPlant:
      "É uma cultura de clima ameno e de elevadas altitudes. Na regiões  Sudeste e Centro-Oeste, somente é possível o cultivo acima de 800 metros de altitude, e em Santa  Catarina e Rio Grande do Sul, acima de 500 metros.",
    bestTimeToPlant: {
      south: "ABRIL/MAIO",
      southeast: "ABRIL/MAIO",
      northeast: "NAO_RECOMENDADO",
      midwest: "ABRIL/MAIO",
      north: "NAO_RECOMENDADO",
    },
    bestWaysToUse:
      "Recomendações de aproveitamento Por ser de fácil digestão, é recomendada para alimentação  infantil, de pessoas doentes e idosas. Pode ser vendida em caixas plásticas, depois de classificada  por tamanho, ou embalada a vácuo, em porções menores, para melhor conservação. É muito  utilizada para processamento em agroindústria, na fabricação de sopas prontas.",
  },
  {
    id: 31,
    popularNames: ["Maxixe"],
    scientificName: "Cucumis anguria L.",
    description:
      "Os frutos são fonte de minerais, principalmente zinco, e têm poucas calorias. O  plantio é feito colocando-se três sementes por cova. Não é muito exigente em adubação e tolera  a acidez do solo. Adapta-se melhor a solos arenosos.",
    bestWayToPlant:
      "É uma hortaliça de clima tropical, suporta temperaturas elevadas  e chuvas abundantes. Em regiões altas só pode ser semeado nos períodos de primavera e verão.  Na Região Norte, o excesso de chuvas pode provocar doenças.",
    bestTimeToPlant: {
      south: "SET/FEV",
      southeast: "SET/FEV",
      northeast: "ANO_TODO",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento Se colhido ainda verde, ele pode ser preparado cru,  como salada, ou cozido como é mais comum ser consumido na forma de sopas ou refogados. É  normalmente vendido para o consumidor final a granel, ou em bandejas de isopor, como forma  de aumentar o valor do produto. Deve-se classificar o maxixe por tamanho e cor, para vender o produto por um preço melhor.",
  },
  {
    id: 32,
    popularNames: ["Melancia"],
    ...
    bestWayToPlant:
      "Exige temperaturas elevadas e não tolera frio nem geadas. Em regiões  de baixa altitude e com irrigação como as observadas no Centro-Oeste, a melancia também pode ser  plantada nos períodos de outono e inverno, utilizando-se irrigação para formar frutos de alta qualidade.",
    bestTimeToPlant: {
      south: "SET/JAN",
      southeast: "AGO/MAR",
      northeast: "MAR/SET",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento A melancia deve ser manuseada com cuidado para evitar  danos mecânicos (pancadas), empilhando no máximo cinco camadas de frutos. É consumida in  natura e na forma de sucos. Da casca podem ser feitos deliciosos doces e compotas.",
  },
  {
    id: 33,
    popularNames: ["Melão"],
    scientificName: "Cucumis melo L. var. inodorus Naud.",
    description:
    ...
    bestWayToPlant:
      "É uma planta de clima quente e todas as fases de desenvolvimento  da planta são prejudicadas por baixas temperaturas (temperatura mínima ideal é em torno de  20°C). Não tolera frio nem geadas. Dias e noites quentes e baixa umidade relativa do ar são as condições ideais para essa cultura.",
    bestTimeToPlant: {
      south: "NAO_RECOMENDADO",
      southeast: "SET/FEV",
      northeast: "MAR/SET",
      midwest: "SET/DEZ",
      north: "ABR/AGO",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento O melão é geralmente consumido in natura e na forma de  sucos. Deve-se ter bastante cuidado no transporte, colocando-os em caixas de papelão. Tem sido  uma excelente opção para produtores do semi-árido nordestino.",
  },
  {
    id: 34,
    popularNames: ["Milho-verde."],
    ...
    bestWayToPlant:
      "Desenvolve-se bem em regiões de clima quente e ameno, sendo  prejudicada pelo frio e geada. Onde não há inverno rigoroso, pode ser plantado o ano todo.",
    bestTimeToPlant: {
      south: "AGO/FEV",
      southeast: "SET/DEZ",
      northeast: "OUT/MAR",
  ...
  },
  {
    ...
    bestWayToPlant:
      "São mais tolerantes que as abóboras em relação a temperaturas mais  baixas e menos tolerante ao excesso de chuvas. É uma planta de clima quente, mas tolera temperaturas  amenas (entre 15° a 25°C). São geralmente plantadas durante a primavera-verão.",
    bestTimeToPlant: {
      south: "SET/DEZ",
      southeast: "SET/DEZ",
      northeast: "MAR/JUN",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento As formas de preparo são semelhantes às da abóbora.  Doces e purês são muito apreciados. Alguns pratos regionais são preparados com a moranga  inteira, como camarão na moranga ou carne seca na moranga.",
  },
  {
    id: 36,
    popularNames: ["Morango"],
    scientificName: "Fragaria X ananassa Duch.",
    description:
    ...
    bestWayToPlant:
      "É originário de clima frio, mas não tolera geadas. Há cultivares adaptadas  a temperaturas amenas (entre 15° e 25°C). Dias curtos de outono-inverno favorecem a frutificação.  Temperaturas elevadas favorecem o crescimento vegetativo e deixam os frutos muito azedos.",
    bestTimeToPlant: {
      south: "MAR/ABR",
      southeast: "MAR/ABR",
      northeast: "NAO_RECOMENDADO",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento Os morangos podem ser comercializados em caixas plásticas  direto ao consumidor final ou podem ser destinados à agroindústria para a produção de sucos,  geléias, doces. Pode ser ingrediente de vários produtos, como iogurtes, biscoitos e tortas.",
  },
  {
    id: 37,
    popularNames: ["Mostarda ou mostarda de folhas"],
    scientificName: "Brassica juncea (L.) Coss.",
    description:
    ...
    bestWayToPlant: "Prefere temperaturas mais amenas (entre 15° e 25°C).",
    bestTimeToPlant: {
      south: "JUL/DEZ",
      southeast: "MAR/AGO",
      northeast: "FEV/JUL",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento Suas folhas são vendidas em maços e podem ser  consumidas cruas ou refogadas. Tem uma vida pós-colheita bastante curta e deve ser rapidamente  comercializada após colhida.",
  },
  {
    id: 38,
    popularNames: ["Nabo"],
    scientificName: "Brassica rapa var. rapa (L.) Thell.",
    description:
    ...
    bestWayToPlant:
      "Prefere temperaturas amenas (entre 15° e 25°C) a frias , suportando  geadas leves. Pode ser semeado nos períodos de outono e inverno na maioria das regiões e, ao  longo do ano, em regiões de elevadas altitudes.",
    bestTimeToPlant: {
      south: "ABR/MAIO",
      southeast: "JAN/AGO",
      northeast: "FEV/JUL",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento A comercialização é feita amarrando-se plantas inteiras em  molhos, depois de serem lavadas. Pode ser consumido em saladas e sopas.",
  },
  {
    id: 39,
    popularNames: ["Pepino"],
    ...
    bestWayToPlant:
      "É uma cultura de clima quente, e se adapta a temperaturas  amenas (entre 15° e 25°C). Frio e geada prejudicam e podem até destruir a cultura. No inverno  não muito rigoroso pode ser cultivada em casas de vegetação (estufa), podendo se beneficiar dos  melhores preços no mercado.",
    bestTimeToPlant: {
      south: "SET/FEV",
      southeast: "SET/FEV",
      northeast: "ANO_TODO",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento Os frutos podem ser acondicionados em caixas plásticas  ou de papelão, devendo ser classificados para que o produtor obtenha melhores preços. São  consumidos crus em saladas ou em conservas, na forma de picles.",
  },
  {
    id: 40,
    popularNames: ["Pimenta"],
    scientificName:
      "Capsicum frutescens L.; Capsicum baccatum L.; Capsicum chinense Jacq., Capsicum praetermissum L.; Capsicum. Annuum L.",
    description:
    ...
    bestWayToPlant:
      "São exigentes em calor e sensíveis a baixas temperaturas  e intolerantes a geadas. Por isso, devem ser cultivadas preferencialmente nos meses de alta  temperatura. Em regiões de baixa altitude, onde o inverno é ameno, as pimentas podem ser  plantadas o ano inteiro.",
    bestTimeToPlant: {
      south: "SET/FEV",
      southeast: "AGO/MAR",
      northeast: "ANO_TODO",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento Podem ser vendidas in natura ou processadas na forma  de pó, flocos, picles, escabeches, molhos líquidos, conservas de frutos inteiros, geléias etc. As pimentas picantes ainda são utilizadas pela indústria farmacêutica, na composição de pomadas  para artrose e artrite, e também pela indústria de cosméticos, na composição de xampus anti-quedas e anticaspas.",
  },
  {
    id: 41,
    popularNames: ["Pimentão"],
    ...
    bestWayToPlant:
      "É uma planta de origem tropical, produzindo melhor sob temperaturas  relativamente elevadas ou amenas (entre 15° e 25°C). Não tolera frio nem geadas, razão pela qual  tem crescido o seu cultivo em casas de vegetação. Onde o inverno é ameno, pode ser cultivado  durante o ano todo.",
    bestTimeToPlant: {
      south: "SET/FEV",
      southeast: "AGO/MAR",
      northeast: "MAIO/SET",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento É vendido verde ou maduro, dependendo da preferência  do mercado consumidor e da logística de entrega (quando colhidos maduros, a vida pós-colheita é menor). Pode ser consumido cru ou como condimento no preparo de vários pratos. Para aumentar o  valor de venda ao consumidor final, os pimentões podem ser acondicionados em bandejas de isopor.",
  },
  {
    id: 42,
    popularNames: ["- quiabo"],
    ...
    bestWayToPlant: "Exige temperaturas altas e não tolera frio.",
    bestTimeToPlant: {
      south: "OUT/DEZ",
      southeast: "AGO/MAR",
      northeast: "ANO_TODO",
  ...
  },
  {
    ...
    bestWayToPlant:
      "Adapta-se melhor ao cultivo nos períodos de outono e inverno,  tolerando bem frio e geadas leves.",
    bestTimeToPlant: {
      south: "MAR/AGO",
      southeast: "MAR/AGO",
      northeast: "MAR/JUL",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento O rabanete é consumido principalmente cru, em saladas,  mas também pode ser consumido cozido ou na forma de picles. É vendido amarrando-se maços  das plantas inteiras.",
  },
  {
    id: 44,
    popularNames: ["Repolho"],
    ...
    bestWayToPlant:
      "Desenvolve-se bem sob temperaturas amenas (entre 15° e 25°C)  e frias, resistindo bem a geadas. Entretanto, há cultivares adaptadas a temperaturas mais altas.",
    bestTimeToPlant: {
      south: "FEV/SET",
      southeast: "FEV/JUL",
      northeast: "FEV/JUL",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento O repolho é consumido cru, em saladas, ou cozido  em sopas, refogados, acompanhando carnes e diversos pratos orientais. Pode também ser  fermentado, para preparação do chucrute, prato alemão. Para venda, as “cabeças” são  acondicionadas em caixas plásticas.",
  },
  {
    id: 45,
    popularNames: ["Rúcula ou pinchão"],
    scientificName: "Eruca sativa L.",
    description:
    ...
    bestWayToPlant:
      "- Produz melhor sob temperaturas amenas (entre 15° e 25°C). Nas  regiões em que o verão é ameno, pode ser plantada durante o ano todo.",
    bestTimeToPlant: {
      south: "MAR/AGO",
      southeast: "MAR/AGO",
      northeast: "MAR/JUL",
  ...
  },
  {
    ...
    bestWayToPlant:
      "É uma planta de clima subtropical. Prefere temperaturas amenas,  não muito frias, nem muito quentes (em torno de 20°C).",
    bestTimeToPlant: {
      south: "MAR/SET",
      southeast: "MAR/SET",
      northeast: "MAR/AGO",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento É vendida em maços, geralmente em conjunto com a  cebolinha, conhecido como cheiro-verde. Dá aroma e sabor a diversos pratos, sendo utilizada  inclusive para preparação de sucos.",
  },
  {
    id: 47,
    popularNames: ["Taioba"],
    scientificName: "Xanthosoma sagittifolium (L.) Schott",
    description:
      "A taioba é da mesma família do inhame. Tanto as folhas quanto os tubérculos são  comestíveis. Suas folhas (parte mais consumida) são ricas em vitamina A, cálcio e fósforo. Não  é muito exigente em adubação, sendo uma planta rústica. Plantam-se os brotos  produzidos ao  redor da planta-mãe.",
    bestWayToPlant:
      "É uma cultura de clima quente e exigente em chuva. Recomenda-se  o plantio nos períodos de primavera e verão, entretanto pode ser plantada durante o ano todo em  regiões baixas com inverno ameno, pois o frio paralisa o crescimento das folhas.",
    bestTimeToPlant: {
      south: "SET/NOV",
      southeast: "SET/NOV",
      northeast: "ANO_TODO",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento As folhas da taioba são consumidas refogadas como a couve.  Cruas causam irritação das mucosas. Podem ser ingredientes de bolinhos e recheio de pizza e  tortas. Suas folhas são vendidas em maços.",
  },
  {
    id: 48,
    popularNames: ["Taro (antigo inhame)"],
    scientificName: "Colocasia esculenta (L.) Schott",
    description:
    ...
    bestWayToPlant:
      "Exige temperaturas elevadas e chuvas abundantes e não tolera geadas.",
    bestTimeToPlant: {
      south: "SET/OUT",
      southeast: "DEZ/JAN",
      northeast: "ANO_TODO",
    ...
    bestWaysToUse:
      "Recomendações de aproveitamento Pode ser consumido cozido, em sopas, refogados, saladas e  sobremesas. Também pode ser industrializado na forma de farinha para fabricação de pães e bolos.",
  },
  {
    id: 49,
    popularNames: ["Tomate"],
    ...
    bestWayToPlant:
      "Desenvolve-se melhor em regiões altas (serras e planaltos) de clima  tropical e também em clima subtropical ou temperado, seco e com alta incidência de luz solar.  Regiões muito úmidas e quentes são problemáticas para a cultura, favorecendo doenças.",
    bestTimeToPlant: {
      south: "SET/FEV",
      southeast: "ANO_TODO",
      northeast: "ANO_TODO",
